...
let currentPageSize = pageSize.value;
...
function updatePagination({ first, last, pageable, totalPages }) {
	const currentPage = pageable?.pageNumber + 1 || 1;
...
function getSelectedPageSize() {
	const pageSizeSelect = document.getElementById('size');
	const selectedSize = pageSizeSelect.options[pageSizeSelect.selectedIndex].value;
	return selectedSize;
}
